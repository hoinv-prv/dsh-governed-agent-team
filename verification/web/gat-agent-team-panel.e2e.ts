// Keyless assembled-browser coverage for the installed Governed Agent Team Web profiles.
...
const SNAPSHOT_DIR = fileURLToPath(new URL('./snapshots/gat-agent-team-panel', import.meta.url))
const PANEL_EXPECTED = join(SNAPSHOT_DIR, 'task.expected.md')
const OVERLAY = fileURLToPath(new URL('./gat-agent-team-panel.overlay.yml', import.meta.url))
const HOST_PATCH = fileURLToPath(new URL('../../../packages/experimental/gat-profile/cordis.patch.yml', import.meta.url))
const WEB_PATCH = fileURLToPath(new URL('../../../packages/experimental/gat-web-profile/cordis.patch.yml', import.meta.url))
const INSTALL_ANCHORS = [
  fileURLToPath(new URL('../../../packages/experimental/gat-profile/package.json', import.meta.url)),
  fileURLToPath(new URL('../../../packages/experimental/gat-web-profile/package.json', import.meta.url)),
]
...
describe('Governed Agent Team panel overlay', () => {
  it('matches the installed Host and Web profile layers', () => {
...
describe('web e2e: Governed Agent Team panel', () => {
