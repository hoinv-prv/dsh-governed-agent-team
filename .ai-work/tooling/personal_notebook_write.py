#!/usr/bin/env python3
"""
aiws-util-personal-notebook helper.
...
def _write_lf(path, content):
    """LF-stable writer (CR-AIWS-2026-08-059) — standalone twin of _common.write_text.

    Path.write_text co newline= tu 3.10; floor du an la 3.8 nen dung open()."""
...
def ensure_notebook(path: Path) -> None:
    ...
    if not inbox.exists():
        _write_lf(inbox, "# Personal Notebook Inbox\n\n---\n\n## Notes\n")
