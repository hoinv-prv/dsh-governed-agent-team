...
Step outputs are stored in `step_outputs/` directory. Each step creates one `STEP-NN.meta.yml` file generated by `run step`. 

Naming: 
- Output ID = `OUT-<aip-id>-<step>-<seq>` (e.g., OUT-1113-03-01)
- Deliverable filename = `STEP-NN_<slug>.<ext>` (e.g., STEP-03_design_proposal.md)

See workspace template for layout and conventions.
